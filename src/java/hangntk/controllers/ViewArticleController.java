...
public class ViewArticleController extends HttpServlet {
    ...
    private static final String SUCCESS = "member.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<TblArticle> result = bloArticle.searchAsPostBy(user);
            if (result != null) {
                request.setAttribute("VIEW", result);
            }
            //            view notification
            NotificationBLO bloNotification = new NotificationBLO();
            List<TblNotification> noti = bloNotification.getNotiByUserEmail(user.getUserEmail());
            if (noti != null) {
