...
public class DetailArticleController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            TblArticle article = blo.findByArticleID(articleID);
            request.setAttribute("ARTICLE", article);

            CommentBLO bloComment = new CommentBLO();
            List<TblComment> result = bloComment.searchCommentByPost(article);

            request.setAttribute("COMMENT", result);
            
        } catch (Exception e) {
            request.setAttribute("ERROR", "Can't read detail Post");
            log("ERROR at DetailArticleController:" + e.getMessage());
        } finally {
